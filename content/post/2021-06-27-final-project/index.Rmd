...
The change in the maximum observed temperature related to the latitude fits the following model, where $\beta_0$ is 44.79679 and $\beta_1$ is -0.30451.  Statistically, both values are significant to a level of confidence greater than 99.99%.
...
### Average Temperature and Latitude
...
The change in the average observed temperature related to the latitude fits the following model, where $\beta_0$ is 20.81364083 and $\beta_1$ is -0.00041804, basically zero.  Statistically, both values are significant to a level of confidence of 90%. 
