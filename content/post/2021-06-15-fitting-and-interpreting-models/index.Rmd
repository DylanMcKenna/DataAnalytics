...
library(ggtext)
library(knitr)
library(kableExtra)  # better presents tables
set.seed(1234) #arbitrary number 0 what is a set.seed?
...
linear_reg() %>%
  set_engine("lm") %>%
  fit(Height_in ~ Width_in, data = pp) #predict height using ~ the width
```
