...
The dataset used for this assignnment was the City of Chicago Crime Statistics data. To reduce the file size, the data is reflective of the year 2019 and the year 2020.  This data is taken from the Chicago Police Departments publicly available data. 
